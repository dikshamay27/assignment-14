#Question 1 :-   Write a Python program to read last n lines .
...
#Question 5 :-        Write a Python program to write 10 random numbers into a file. Read the file and then sort the numbers and then store it to another 
file.
